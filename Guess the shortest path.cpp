...
void welcome_note(){
    ...
    cout <<"\nRULE : SHUBHAM IS LOST ON AN ABONDONED ISLAND,\n       FORTUNATELY, HE HAS HIS BOAT WITH HIM BUT HE HAS\n       VERY LIMITED RESOURCES TO KEE HIM ALIVE. ALSO HE\n       HAS A WORLD MAP WHICH SHOWS THE DISTANCE TO\n       THE NEAREST CITIES. CURRENTLY HE IS AT CITY\n       NUMBER 0 (CITIES ARE NUMBERED FROM 0 TO 9), \n       HELP SHUBHAM TO FIND A ROUTE TO CITY 10 WITH\n       LEAST DISTANCE COVERED IF ITS POSSIBLE.\n";
}
